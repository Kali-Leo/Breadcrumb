/**
 * Purpose: the 🪞 feedback lab's "趋势" section (spec 035 T7a) — a three-layer estimate curve
 * (memory / understanding / intuition, all forgetting-decayed) plus the settled word-progress
 * line, each measured only against the past self, no target lines.
      ...
      {isEmpty ? (
        ...
        <div className="mt-2 flex flex-col gap-4">
          <TrendCard title={FEEDBACK_COPY.trendLayersTitle}>
            ...
            <p className="mt-1 text-[10px] text-stone-400">{FEEDBACK_COPY.trendLayersBasis}</p>
          </TrendCard>
          {hasWordData && (
