...
export function KingdomTreeSvg({
  ...
  if (layout.stations.length === 0) {
    return <p className="text-sm text-stone-400">这个国度还没有落座的知识点。</p>;
  }
  ...
  return (
    ...
    >
      <defs>
        <marker id="lateral-arrow" markerWidth="6" markerHeight="6" refX="6" refY="3" orient="auto">
      ...
      {layout.stations.map((station) => {
        ...
        const activate = () => (isAggregate ? onExpandAggregate(station.id) : onSelect(station.id));
        return (
