...
// shows its failure state. The browser edition hits that; the desktop webview is lenient
// today but declares the same policy, so the safe path is taken everywhere.
