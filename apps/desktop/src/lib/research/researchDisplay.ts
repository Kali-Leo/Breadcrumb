...
import { type DisplayBlock, displayBlockSchema } from "@breadcrumb/feature-research";
import { z } from "zod";
...
// Mirrors @breadcrumb/feature-research's StatResult type (statResults.ts exports the type
