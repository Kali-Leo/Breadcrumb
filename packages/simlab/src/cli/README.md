...
| `self-report-pending-resolved` | `day`, `label`                                                 | a self-reported knownTopic that had no matching tree node at self-report time finally matched — either at the start of a later self-report action or at day end (S4 requeue) |
