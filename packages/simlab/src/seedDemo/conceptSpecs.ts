/**
 * Purpose: combines the demo seed's three node-spec buckets (spec 035 T7b) into the one list
...
export const ALL_CONCEPT_SPECS: readonly ConceptSpec[] = [...MASTERED, ...WAITING, ...FRESH];
