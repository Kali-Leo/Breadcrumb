/**
 * Purpose: unit tests for createKnowledgeEdgesRepo — the ON CONFLICT ... WHERE
 * confidence-guarded upsert semantics and the directional queries — against a fake SqlClient
 * that simulates the real UNIQUE(source_id, target_id, edge_type) constraint.
 */
import { describe, expect, it } from "vitest";
import { createKnowledgeEdgesRepo } from "./edgesRepository";
